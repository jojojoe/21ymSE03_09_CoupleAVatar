...
class APLoginVC: FUIAuthPickerViewController, FUIAuthDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        Notice.Center.default.post(name: .pi_noti_loginVcClose, with: nil)
...
//        view.addSubview(bgOvermaskView)
        ...
        //
        let userInfoImgV = UIImageView(image: UIImage(named: "login_photo"))
        ...
        userInfoImgV.snp.makeConstraints {
            ...
            $0.width.equalTo(478/2)
            $0.height.equalTo(490/2)
        }
...
//        //
        ...
        topInfoLabel.font = UIFont(name: "Pacifico-Regular", size: 26)
        ...
        topInfoLabel.text = "Welcome to Best Love Couple Photo Maker"
        view.addSubview(topInfoLabel)
        topInfoLabel.snp.makeConstraints {
            $0.top.equalTo(view.snp.centerY).offset(0)
            $0.centerX.equalToSuperview()
            $0.width.equalTo(280)
