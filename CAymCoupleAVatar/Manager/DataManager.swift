...
struct OverlyerTypeItem: Codable {
    var isPro: Bool? = false
    var thumb: String? = ""
    var bigImg: String? = ""
    var preview: String? = ""
...
//    }
    var avatarOverlayerTypeList: [OverlyerTypeItem] {
        return DataManager.default.loadJson([OverlyerTypeItem].self, name: "avatarOverlyerTypeList") ?? []
    }
    
    var postsOverlayerTypeList: [OverlyerTypeItem] {
        return DataManager.default.loadJson([OverlyerTypeItem].self, name: "postsOverlyerTypeList") ?? []
    }
