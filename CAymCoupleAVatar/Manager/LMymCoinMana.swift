...
extension Notice.Names {
    ...
    static let pi_noti_loginVcClose = Notice.Name<Any?>(name: "pi_noti_loginVcClose")
...
class LMymBCartCoinManager: NSObject {
    ...
    func loadDefaultData() {
        ...
        let iapItem0 = StoreItem.init(id: 0, iapId: "com.coupame.likigpic.listone", coin: 100, price: "$0.99", color: "#FFDCEC")
        let iapItem1 = StoreItem.init(id: 1, iapId: "com.coupame.likigpic.listtwo", coin: 300, price: "$1.99", color: "#C9FFEE")
        let iapItem2 = StoreItem.init(id: 2, iapId: "com.coupame.likigpic.listthree", coin: 500, price: "$2.99", color: "#FFDCEC")
        let iapItem3 = StoreItem.init(id: 3, iapId: "com.coupame.likigpic.listfour", coin: 1000, price: "$5.99", color: "#C9FFEE")
        let iapItem4 = StoreItem.init(id: 4, iapId: "com.coupame.likigpic.listfive", coin: 2000, price: "$8.99", color: "#FFDCEC")
        let iapItem5 = StoreItem.init(id: 5, iapId: "com.coupame.likigpic.listsix", coin: 3000, price: "$10.99", color: "#C9FFEE")
        let iapItem6 = StoreItem.init(id: 6, iapId: "com.coupame.likigpic.listseven", coin: 4000, price: "$12.99", color: "#FFDCEC")
        let iapItem7 = StoreItem.init(id: 7, iapId: "com.coupame.likigpic.listeight", coin: 5000, price: "$13.99", color: "#C9FFEE")
